      ...
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" onClick={e => e.stopPropagation()}>
        <div className="mt-3 text-center">
          ...
          <div className="mt-4 flex flex-col space-y-2">
            ...
            <button className="px-4 py-2 bg-teal-400 text-white text-base font-medium rounded-md shadow-sm hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-green-300">
              Account Settings
            </button>
